...
@section('breadcrumbs', Breadcrumbs::render($breadcrumbs, $contacts ?? null, $transactions ?? null))
...
@section('content')
    ...
    <main class="flex-1 container mx-auto bg-white overflow-hidden px-4 sm:px-6">
        <div class="flex-grow-1 py-3 justify-content-between min-мh-100">
            ...
            <div>
                <a href="{{ route('contacts.create') }}" class="btn btn-primary mb-3 mt-3">Добавить контакт</a>
            </div>
            <div class="py-1">
